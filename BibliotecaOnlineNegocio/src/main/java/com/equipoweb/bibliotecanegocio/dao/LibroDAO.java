...
/**
 * Implementación del DAO para gestionar las operaciones CRUD de la entidad Libro en la base de datos.
 * Utiliza la clase Conexion para gestionar las conexiones a la base de datos.
 * 
 * @author Saul Neri
 */
